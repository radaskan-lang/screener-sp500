...
with st.sidebar:
    ...
    include_nasdaq = st.checkbox("Nasdaq 100", value=False, key="inc_ndx", help="Ajoute ~35 titres")
    include_russell = st.checkbox("Russell 200", value=False, key="inc_russ", help="Ajoute ~50 titres mid-cap")
