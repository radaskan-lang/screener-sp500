...
if st.button(f"\ud83d\udd04 Lancer \u2014 S&P 500 complet ({len(SP500_TICKERS)} actions)"):
    ...
    if use_prefilter:
        ...
        st.markdown(f"""<div class="prefilter-banner">
            ...
            &nbsp;/&nbsp; {pf_result['n_total']}
            &nbsp;|&nbsp; {pf_result['n_failed']} \u00e9limin\u00e9es
            &nbsp;|&nbsp; {pf_result['pass_rate']}% passage
        </div>""", unsafe_allow_html=True)
        with st.expander(f"\ud83d\uddd1\ufe0f {pf_result['n_failed']} actions \u00e9limin\u00e9es"):
            ...
            <div class="{card_class}">
                ...
                <div style="display:flex;align-items:center;gap:20px;margin-bottom:14px;flex-wrap:wrap;">
                    <div>
                        ...
                        <div style="font-size:11px;color:{conv_clr};font-family:'Space Mono',monospace;">{n_sig}/7 signaux</div>
                    </div>
