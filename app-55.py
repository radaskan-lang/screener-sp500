                    ...
                    for _str in _strats_sel:
                        try:
                            add_paper_trade(
                                ...
                                entry_price=_r.get("Entree", _r.get("Prix",0)),
                                stop_price=_r.get("Stop",0),
                                target_price=_r.get("Target",0),
                                conv_n=int(_r.get("Conv_N",0)),
                                score=_r.get("Score_Final",0),
                                strategy=_str,
                                sector=str(_r.get("Sector","N/A")),
                                week_date=_week,
                            )
                            _count += 1
                            _prog.progress(min(1.0, _count/_total_preview))
                        except Exception:
                            _errors += 1
            st.success(f"{_count} trades crees avec succes!")
